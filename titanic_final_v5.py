...
def fill_missing_age(missing_age_train, missing_age_test):
    ...
    gbm_reg = ensemble.BaggingRegressor(random_state = 42)  
    gbm_reg_param_grid = {'n_estimators': [5000], 'max_features': [10]}
    ...
    print("Age feature Best Score: " + str(gbm_reg_grid.best_score_))
...
def top_n_features(df_X, df_y, top_n):
    ...
    rf_param_grid = {'n_estimators' : [500, 1000], 'min_samples_split':[2, 3, 4], 'max_depth':[15, 20], 'max_features': [50, 60]}
    ...
    print("Top N Features Best Score: " + str(rf_grid.best_score_))
    print("Top N Features RF Grid Score: " + str(rf_grid.score(df_X, df_y)))
